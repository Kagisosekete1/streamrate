...
const moreItems = [
  ...
  { icon: CalendarClock, label: "Schedule", path: "/schedule", color: "text-amber-500", bg: "bg-amber-500/10" },
  { icon: Gamepad2, label: "Squad Up", path: "/squad-up", color: "text-blue-500", bg: "bg-blue-500/10" },
  { icon: TrophyIcon, label: "Tournaments", path: "/tournaments", color: "text-yellow-500", bg: "bg-yellow-500/10" },
  { icon: Users, label: "Co-Stream", path: "/co-stream", color: "text-sky-500", bg: "bg-sky-500/10" },
  { icon: Swords, label: "Raids", path: "/raids", color: "text-rose-500", bg: "bg-rose-500/10" },
  { icon: Gamepad2, label: "My Games", path: "/games", color: "text-violet-500", bg: "bg-violet-500/10" },
  { icon: Wrench, label: "My Gear", path: "/gear", color: "text-teal-500", bg: "bg-teal-500/10" },
  { icon: Terminal, label: "Commands", path: "/commands", color: "text-lime-500", bg: "bg-lime-500/10" },
  ...
  { icon: Trophy, label: "Leaderboard", path: "/leaderboard", color: "text-amber-400", bg: "bg-amber-400/10" },
