  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <motion.button
          whileTap={{ scale: 0.92 }}
          className="md:hidden fixed bottom-24 right-4 z-40 w-11 h-11 rounded-full bg-background/95 backdrop-blur-lg border border-border shadow-lg shadow-black/20 flex items-center justify-center"
